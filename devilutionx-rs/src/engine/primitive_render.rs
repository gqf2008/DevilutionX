...
pub fn draw_half_transparent_horizontal_line(
    ...
    for x in x0..x1 {
        set_half_transparent_pixel(out, Point::new(x, from.y), color_index, lookup);
    }
}
...
pub fn draw_half_transparent_vertical_line(
    ...
    for y in y0..y1 {
        set_half_transparent_pixel(out, Point::new(from.x, y), color_index, lookup);
    }
}
...
pub fn draw_half_transparent_rect(
    ...
    draw_half_transparent_rect_colored(out, sx, sy, width, height, 0, lookup);
}

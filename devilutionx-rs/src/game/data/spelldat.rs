...
pub static SPELLS_DATA: [SpellData; SpellID::COUNT] = [
    ...
    SpellData {
        ...
        staff_level: 4,
        min_int: 40,
        missiles: [MissileID::FireWall, MissileID::Null],
        mana_adj: 1,
        min_mana: 12,
        staff_min: 10,
        staff_max: 20,
    ...
    SpellData {
        ...
        staff_cost_10: 125,
        mana_cost: 20,
        flags: SpellDataFlags::with_flags(MagicType::Magic, true, true),
        book_level: 5,
        staff_level: 3,
        min_int: 30,
        missiles: [MissileID::ResurrectBeam, MissileID::Null],
        mana_adj: 4,
        min_mana: 4,
        staff_min: 10,
        staff_max: 30,
    ...
    // 37-51: Hellfire spells (simplified placeholders)
    // 37: Mana
    SpellData {
        name: "Mana",
        sfx: SfxID::CastSkill,

...
pub enum SpeechId {
    ...
    #[default]
    // Quest-start / Hellfire speeches (C++ textdat.h `_speech_id`).
    BoneR = 235,
    BloodY = 236,
    BlindIng = 237,
    BloodWar = 238,
...
pub fn get_quest_data() -> Vec<QuestData> {
    ...
    QuestData {
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: true,
        _qdmsg: SpeechId::Banner2,
        _qlstr: "Ogden's Sign".to_string(),
    },
    // 8: Halls of the Blind
    QuestData {
        _qdlvl: 7,
        _qdmultlvl: -1,
        _qlvlt: DungeonType::None,
    ...
    QuestData {
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: true,
        _qdmsg: SpeechId::BloodWar,
        _qlstr: "Warlord of Blood".to_string(),
    },
    // 12: The Curse of King Leoric
    QuestData {
        _qdlvl: 3,
        _qdmultlvl: 3,
        ...
        is_single_player_only: false,
        _qdmsg: SpeechId::King2,
        _qlstr: "The Curse of King Leoric".to_string(),
    },
    // 13: Poisoned Water Supply
    QuestData {
        _qdlvl: 2,
        _qdmultlvl: -1,
        ...
        is_single_player_only: true,
        _qdmsg: SpeechId::Poison3,
        _qlstr: "Poisoned Water Supply".to_string(),
    },
    // 14: The Chamber of Bone
    QuestData {
        _qdlvl: 6,
        _qdmultlvl: -1,
    ...
    QuestData {
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: true,
        _qdmsg: SpeechId::Trader,
        _qlstr: "Wandering Trader".to_string(),
    },
    // 20: The Defiler
    QuestData {
        _qdlvl: 17,
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: false,
        _qdmsg: SpeechId::Defiler1,
        _qlstr: "The Defiler".to_string(),
    },
    // 21: Na-Krul
    QuestData {
        _qdlvl: 21,
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: false,
        _qdmsg: SpeechId::Nakrul1,
        _qlstr: "Na-Krul".to_string(),
    },
    // 22: Cornerstone of the World
    QuestData {
        _qdlvl: 21,
        _qdmultlvl: -1,
        _qlvlt: DungeonType::None,
        ...
        _qslvl: SetLevel::None,
        is_single_player_only: true,
        _qdmsg: SpeechId::Cornstn,
        _qlstr: "Cornerstone of the World".to_string(),
    },
    // 23: The Jersey's Jersey
    QuestData {
        _qdlvl: 9,
        _qdmultlvl: 9,
        _qlvlt: DungeonType::None,
